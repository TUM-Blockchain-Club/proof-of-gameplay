    ...
    while running: # While the game is running
        ...
        if cnt < len(inputs):
            if inputs[cnt] < aktTime + frameTime: #in this frame a jump was triggered
                print(str(aktTime + frameTime) + " " + str(inputs[cnt]))
                cnt += 1     
                print(frameCnt)
                for bird in birds:
...
if __name__ == "__main__":
    inputs = [0.0, 0.8906316757202148, 1.4569144248962402, 1.8977680206298828, 2.5447804927825928, 3.029797315597534, 3.473071336746216, 4.359496355056763, 4.802177906036377, 5.246103525161743, 5.728710651397705, 
6.092083930969238, 6.453383922576904, 6.901537656784058, 7.74937891960144, 8.234166860580444, 9.080150842666626, 9.401283264160156, 9.884256601333618, 10.732106685638428, 11.13735580444336, 11.702994108200073, 11.904006958007812, 12.106855154037476, 12.30969500541687, 12.752007246017456, 14.080523252487183, 14.64738941192627, 14.93101716041565, 15.130818367004395]
    asyncio.run(simulate(inputs))


#[0, 20, 35, 48, 60, 74, 85, 107, 118, 130, 140, 147, 158, 178, 191, 206, 217, 233, 245, 265, 276, 293, 298, 303]